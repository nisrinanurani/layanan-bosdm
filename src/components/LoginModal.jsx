    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            <motion.div
                ...
                className="relative bg-bosdm-paper w-full max-w-sm rounded-[40px] shadow-2xl overflow-hidden p-8 text-center"
            >
                ...
                <div className="space-y-3">
                    ...
                    <button
                        ...
                        className="w-full flex items-center gap-4 p-4 bg-bosdm-paper hover:bg-bosdm-sky border border-slate-200 rounded-2xl transition-all group"
                    >
