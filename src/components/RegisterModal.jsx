                ...
                <>
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-bosdm-paper w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden relative"
                        >
                            <div className="bg-bosdm-paper p-6 text-center border-b border-slate-100 relative">
                            ...
                            <div className="p-8 bg-bosdm-paper">
