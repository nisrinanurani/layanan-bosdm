    ...
    return (
        <div className="min-h-screen bg-brand-gray-50 pb-20 font-sans">
            ...
            <main className="max-w-5xl mx-auto px-6">
                ...
                {/* AREA ARTIKEL */}
                <article className="bg-white rounded-[3.5rem] p-8 md:p-16 shadow-xl border border-white">
                    {berita.tipe === 'BERITA' ? (
                        <>
                            {berita.gambar && (
            ...
            <style>{`
                .quill-render { word-break: break-word; }
                .quill-render h1, .quill-render h2, .quill-render h3 {
                    color: #0F172A; font-weight: 900; text-transform: uppercase;
                    margin-top: 3rem; margin-bottom: 1.5rem; line-height: 1.2; letter-spacing: -0.02em;
                }
                ...
                .quill-render img {
                    max-width: 100%; height: auto; border-radius: 2rem;
                    margin: 3rem 0; display: block; box-shadow: 0 25px 50px -12px rgb(0 0 0 / 0.1);
                }
                .quill-render blockquote {
                    border-left: 6px solid #1D4ED8; background: #F0F6FF;
                    padding: 2.5rem; border-radius: 0 2.5rem 2.5rem 0;
                    font-style: italic; margin: 2.5rem 0; color: #475569;
                }
                .quill-render ul, .quill-render ol { padding-left: 1.5rem; margin-bottom: 2rem; }
