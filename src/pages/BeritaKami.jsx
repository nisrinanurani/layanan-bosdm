            ...
            <main className="max-w-7xl mx-auto py-12 px-6">
                ...
                <div className="flex flex-col md:flex-row items-center gap-4 mb-8">
                    <div className="relative w-full md:w-80">
                        <input
                            ...
                            className="w-full pl-4 pr-10 py-2.5 bg-bosdm-paper border border-slate-200 rounded-full text-sm outline-none focus:ring-2 focus:ring-blue-500 shadow-sm"
                            value={searchBerita}
                    ...
                    <div className="ml-auto flex items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                        ...
                        <div className="relative flex items-center">
                            <select
                                ...
                                className="appearance-none bg-bosdm-paper border border-slate-200 pl-3 pr-7 py-1.5 rounded-md text-slate-900 outline-none cursor-pointer font-bold"
                            >
                ...
                <div className="bg-bosdm-paper border border-bosdm-navy/20 rounded-2xl shadow-sm overflow-hidden">
                    <table className="w-full text-left text-xs">
                        <thead className="bg-bosdm-sky border-b border-bosdm-navy/20 text-slate-400 font-bold uppercase">
                            <tr>
                        ...
                        <tbody className="divide-y divide-slate-50 border-b border-slate-100">
                            {filteredBerita.slice(0, limit).map((item, idx) => (
                                <tr key={item.id} className="hover:bg-bosdm-sky transition-colors">
